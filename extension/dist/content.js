...
(() => {
  ...
  function getBoard() {
    return document.querySelector("wc-chess-board .board") || document.querySelector("chess-board .board") || document.querySelector(".board-layout-main .board") || document.querySelector("wc-chess-board") || document.querySelector("chess-board");
  }
